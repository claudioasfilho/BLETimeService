...
uint8_t bg_gattdb_data_attribute_field_30_data[4]={0x04,0xff,0xff,0xff,};
...
uint8_t bg_gattdb_data_attribute_field_10_data[16]={0x43,0x61,0x6c,0x65,0x6e,0x64,0x61,0x72,0x20,0x45,0x78,0x61,0x6d,0x70,0x6c,0x65,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x0010,.permissions=0x800,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_2},
    ...
    {.uuid=0x0011,.permissions=0x801,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_5},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_6},
    {.uuid=0x0012,.permissions=0x803,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_7},
    ...
    {.uuid=0x000b,.permissions=0x803,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_25},
    ...
    {.uuid=0x000d,.permissions=0x801,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_28},
...
GATT_DATA(const uint8_t bg_gattdb_data_adv_uuid16_map[])={0x05, 0x18, };
